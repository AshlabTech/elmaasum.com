...
<div id="affective" style="padding: 10px;">
		<div class="row">
			<div class="col-sm-4 col-xs-4 trt">Trait</div>
			<div class="col-sm-7 col-xs-7 trt">Rating</div>
		</div>
		<div>
		<?php
		...
		?>
		<div class="row bd">
			<div class="col-sm-4 col-xs-4 co"><?php echo $f_a['a_name']?></div>
			<div class="col-sm-7 col-xs-7 " style="padding: 8px; width: 170px;">
...
<div id="psycomotor" style="padding: 10px; display: none;">
		...
		?>
		<div class="row bd">
			<div class="col-sm-4 col-xs-4 co"><?php echo $f_a['p_name']?></div>
			<div class="col-sm-7 col-xs-7 " style="padding: 8px; width: 170px;">
		...
		<?php
					...
					<div class="row bd">
						<div class="col-sm-4 col-xs-4 co"><?php echo $f_a['p_name']?></div>
						<div class="col-sm-6 col-xs-6 " style="padding: 10px; width: 180px;">
...
<script>
	...
	function saveResultBtn(){
		...
		if(type=='affective_domain'){
			...
			$('#load11').show();
			$.post('save-traits.php',{type: 'affective',selVal:selVal,stid:<?php echo $stid;?>,sid:<?php echo $sid?>,tid:<?php echo $tid?>,bid:<?php echo $bid?>}, function(data){
					$('#load11').hide();
				if(data==1){
					$('#errMsg').show();
			...
			$.post('save-traits.php',{type: 'psycomotor',selVal:selVal,stid:<?php echo $stid?>,sid:<?php echo $sid;?>,tid:<?php echo $tid; ?>,bid:<?php echo $bid;?>}, function(data){
				$('#load11').hide();
				if(data==1){
					$('#errMsg').show();
					$('#errMsg').html('<p class="alert alert-success" style="padding:3px; width:100%;"> Saved </p>');
